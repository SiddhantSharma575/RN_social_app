        ...
        <SafeAreaView style={styles.main__container}>
            ...
            <View style={styles.login__container}>
                ...
                <TouchableOpacity style={{ width: "100%", height: 40, marginLeft: 44, marginBottom: 10 }}>
                    <CustomButton text="Login" color="#fff" bg="#0398fc" onPress={() => navigation.navigate("Home")} />
                </TouchableOpacity>
                <TouchableOpacity style={{ width: "100%", height: 40, marginLeft: 44 }}>
                    <CustomButton text="Register" color="#fff" bg="#0398fc" onPress={() => navigation.navigate("Register")} />
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
